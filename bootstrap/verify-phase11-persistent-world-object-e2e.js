...
ok('E ambiguity mode is contextual',()=>assert.strictEqual(reBefore.matchMode,'object_context_ambiguous'));
ok('E ambiguity reason is multiple candidates',()=>assert.strictEqual(reBefore.reason,'multiple_compatible_generic_candidates'));
